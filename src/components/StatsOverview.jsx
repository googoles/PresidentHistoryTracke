        ...
        <div className="text-center">
          <div className="relative inline-flex items-center justify-center">
            ...
            <div className="absolute flex flex-col items-center">
              <span className="text-3xl font-bold text-gray-800">{stats.achievementRate}%</span>
              <span className="text-sm text-gray-600">이행률</span>
            </div>
          </div>
          <p className="mt-2 text-sm text-gray-600">전체 공약 이행률</p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-600">전체 공약</span>
              ...
              return (
                <div key={status} className="space-y-2">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="text-gray-600">{count}개 ({Math.round(percentage)}%)</span>
                  </div>
